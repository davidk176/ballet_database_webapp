            ...
            <div id ="container">
                <div class="row">
                    <div class="col s5 offset-s1">
                        <h4 style="font-weight: 300;">Edit a Piece</h4>
                        </br>
                        <form action="pieceUpdate.php">
    			<p>
        		    <label for="pieceName">Piece Name:</label>
    			    <input type="text" name="pieceName" value="<?php echo $_REQUEST["pieceName"] ?>">
   			</p>
    			<p>
        		    <label for="composer">Composer:</label>
    			    <input type="text" name="composer" value="<?php echo $_REQUEST["composer"] ?>">
    			</p>
    			<p>
