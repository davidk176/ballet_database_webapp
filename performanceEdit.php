            ...
            <div id ="container">
                <div class="row">
                    <div class="col s5 offset-s1">
                        <h4 style="font-weight: 300;">Edit a Performance</h4>
                        </br>
                        <form action="performanceUpdate.php">
    			<p>
        		    <label for="performanceName">Performance Name:</label>
    			    <input type="text" name="performanceName" value="<?php echo $_REQUEST["performanceName"] ?>">
   			</p>
    			<p>
        		    <label for="performanceDate">Date:</label>
    			    <input type="text" name="performanceDate" value="<?php echo $_REQUEST["performanceDate"] ?>">
    			</p>
    			<p>
